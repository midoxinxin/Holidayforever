...
个人或组织主页
项目主页
对于普通的博主来说，用哪种并无所谓，本系列文章将采用项目主页，刚好我自己也有项目。更多关于主页类型，请参见：User, Organization and Project Pages

另外，再次重申一下，GitHub-Pages仅仅为我们提供了静态页面的托管，不要说不能用wordpress，连基本的评论，访问统计都得自己想办法（幸好都有解决方案，后面会慢慢介绍）。
